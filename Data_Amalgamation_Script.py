...
# Below is an example
# labels=["Image_Number", "Image_Title.String", "nm_per_pixel", "wfft_Period_nm", "Defect_Density_um", "correlation_length", "correlation_length_linear", "opa_bar_R_squared", "LER_sigma_avg_nm", "LWR_sigma_avg_nm"]
